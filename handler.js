            ...
            if (chat.welcome) {
              ...
              let lea = await new knights.Goodbye()
                ...
                .toAttachment()
                       ...
                       await this.sendHydrated(id, text, 'Bot Papah-Chan', action === 'add' ? wel.toBuffer() : lea.toBuffer(), 'github.com/FahriAdison', (action == 'add' ? ' Welcome 👋' : 'Sayonaraa 👋'),user.split`@`[0], 'USER NUMBER', [
      [null, null],
      [null, null]
...
global.dfail = (type, m, conn) => {
    ...
    if (msg) return conn.reply(m.chat, msg, m, { contextInfo: { externalAdReply: {title: "Bot Papah-Chan", body: '404 Access denied!', sourceUrl: "github.com/FahriAdison", thumbnail: fs.readFileSync('./null.png') }}})
}
